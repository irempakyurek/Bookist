...
public class RealmBook3 extends RealmObject
    ...
    private RealmList<RealmString3> authors;
    ...
    public static RealmBook3 convertBookToPO(Book book) {
        ...
        for (String author : vInfo.getAuthors()) {
            realmBook.authors.add(new RealmString3(author));
        }
    ...
    public RealmList<RealmString3> getAuthors() {
        return authors;
    }

    public void setAuthors(RealmList<RealmString3> authors) {
