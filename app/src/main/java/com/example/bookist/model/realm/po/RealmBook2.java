...
public class RealmBook2 extends RealmObject
    ...
    private RealmList<RealmString2> authors;
    ...
    public static RealmBook2 convertBookToPO(Book book) {
        ...
        for (String author : vInfo.getAuthors()) {
            realmBook.authors.add(new RealmString2(author));
        }
    ...
    public RealmList<RealmString2> getAuthors() {
        return authors;
    }

    public void setAuthors(RealmList<RealmString2> authors) {
